...
import (
	...
	"github.com/mehrfunds/mehr/docs"
	mehrkeeper "github.com/mehrfunds/mehr/x/mehr/keeper"
)
...
func New(
	...
	if err := app.registerMehrModule(appOpts); err != nil {
		panic(err)
	}
